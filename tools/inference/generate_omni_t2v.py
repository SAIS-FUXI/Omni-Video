...
def _parse_args():
    ...
    # ============================================================================
    # VLM E2E Arguments (Online feature extraction)
    # ============================================================================
    parser.add_argument(
        "--qwen3vl_model_path",
        type=str,
...
def generate(args):
    ...
    for idx, prompt_dict in enumerate(prompt_list):
        ...
        # Online Qwen3-VL feature extraction and caption prediction (Unified for T2V/V2V)
        if args.qwen3vl_model_path:
            ...
            if source_video_path is not None:
                # V2V: Concatenate target and edit prompt embeddings
                ...
                # T2V (VBench): Use expanded target caption as context and prompt
                precomputed_context = target_t5_emb
                prompt = target_video_caption
        ...
        if video is not None and is_save_rank:
            ...
            if source_video_path:
                ...
                save_file = os.path.join(output_dir, f"{source_basename}_id{sample_id}_generated.mp4")
            else:
                save_file = os.path.join(output_dir, f"output_id{sample_id}_generated.mp4")
