...
t2v_A14B = EasyDict(__name__='Config: OmniVideo T2V A14B')
t2v_A14B.update(omnivideo_shared_cfg)
...
t2v_A14B.use_visual_context_adapter = True
t2v_A14B.visual_context_adapter_patch_size = (1, 4, 4)
t2v_A14B.condition_mode = "full"
t2v_A14B.vlm_in_dim = 2048  # Qwen3-VL hidden dimension
