...
"${BASE_CMD[@]}" \
    --prompt "Generate a video about: A beautiful sunset over the ocean with gentle waves" \
    --size "832*480" \
    --frame_num "81" \
    --sample_steps "50" \
    --sample_fps "16" \
...
"${BASE_CMD[@]}" \
    --prompt "Generate a video about: A cat playing with a ball of yarn in slow motion" \
    --size "832*480" \
    --frame_num "81" \
    --sample_steps "50" \
    --sample_fps "16" \
...
# V2V Task 3
"${BASE_CMD[@]}" \
    --prompt "replace the snow with autumn leaves on the mountains" \
    --size "640*352" \
    --frame_num 17 \
    --sample_fps 8 \
    --sample_steps 40 \
    ...
    --sampling_rate 2 \
    --base_seed "1573" \
    --src_file_path "examples/source_3.mp4"

# V2V Task 4
"${BASE_CMD[@]}" \
    --prompt "replace the panda with a human" \
    --size "640*352" \
    --frame_num 17 \
    --sample_fps 8 \
    --sample_steps 40 \
    ...
    --sampling_rate 2 \
    --base_seed "1573" \
    --src_file_path "examples/source_4.mp4"

# V2V Task 5
"${BASE_CMD[@]}" \
    --prompt "replace the fish with a sea turtle swimming" \
    --size "640*352" \
    --frame_num 17 \
    --sample_fps 8 \
    --sample_steps 40 \
    ...
    --sampling_rate 2 \
    --base_seed "1573" \
    --src_file_path "examples/source_5.mp4"

# V2V Task 6
"${BASE_CMD[@]}" \
    --prompt "Eliminate the man" \
    --size "640*352" \
    --frame_num 17 \
    --sample_fps 8 \
    --sample_steps 40 \
...
# T2I Task 1
"${BASE_CMD[@]}" \
    --prompt "Generate an image about: A black and white photograph of a serene mountain lake surrounded by trees. The mountain can be seen in the distance, towering over the lake. The reflection of the mountain and its snowy peak can be seen clearly in the calm waters of the lake." \
    --size "480*480" \
    --frame_num "1" \
    --sample_steps "50" \
    --sample_guide_scale "5.0" \
...
# T2I Task 2
"${BASE_CMD[@]}" \
    --prompt "Generate an image about: Antarctic icebergs sculpted by polar winds. Azure caverns glow in monumental ice cliffs floating through silver seas where penguins porpoise through waves." \
    --size "480*480" \
    --frame_num "1" \
    --sample_steps "50" \
    --sample_guide_scale "5.0" \
...
# T2I Task 3
"${BASE_CMD[@]}" \
    --prompt "Generate an image about: A futuristic image featuring a woman with glowing yellow eyes. She is wearing a black and gold outfit, which is adorned with intricate patterns and lights. The woman has long hair, and her eyes are prominently glowing yellow. She is the main focus of the scene." \
    --size "480*480" \
    --frame_num "1" \
    --sample_steps "50" \
    --sample_guide_scale "5.0" \
...
# T2I Task 4
"${BASE_CMD[@]}" \
    --prompt "Generate an image about: An image that captures the essence of retro chic. At the center of the frame is a woman exuding a sense of confidence and style." \
    --size "480*480" \
    --frame_num "1" \
    --sample_steps "50" \
    --sample_guide_scale "5.0" \
